package com.yc.library.db.manager;

import android.content.ContentValues;
import android.content.Context;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
import com.yc.library.bean.*;
import com.yc.library.db.AssetsDatabaseManager;
import com.yc.library.db.TableField;


import java.util.ArrayList;
import java.util.List;

import static com.yc.library.db.TableField.ADDRESS_DICT_FIELD_CODE;
import static com.yc.library.db.TableField.ADDRESS_DICT_FIELD_ID;
import static com.yc.library.db.TableField.ADDRESS_DICT_FIELD_PARENTID;
