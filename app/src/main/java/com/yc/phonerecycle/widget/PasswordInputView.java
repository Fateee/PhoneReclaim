...
public class PasswordInputView extends AppCompatEditText {
    ...
    private static final int defaultSplitLineWidth = 2;
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        passwordWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, passwordWidth, dm);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        borderPaint.setColor(Color.parseColor("#f6f6f6"));
