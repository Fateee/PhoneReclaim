...

{
    ...
    static final String TAG = ClipZoomImageView.class.getSimpleName();
    public static float SCALE_MAX = 4.0f;
    static float SCALE_MID = 2.0f;
    ...
    final Matrix mScaleMatrix = new Matrix();
    ...
    public ClipZoomImageView(@NonNull Context context)
    {
        this(context, null);
    }

    public ClipZoomImageView(@NonNull Context context, AttributeSet attrs)
    {
        super(context, attrs);
     ...
     * @return
     */
    boolean isCanDrag(float dx, float dy)
    {
